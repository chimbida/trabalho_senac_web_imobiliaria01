...
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
        <div class="container">
            <br><br>
            <h1 class="header center lime-text text-accent-2" >Aluguel de Imóveis</h1>
    ...
    function verifica() {
        ...
        if(elementValues){
            Object.keys(elementValues).forEach(function(element) {
                ...
                if(checked) {
                    urlvar = "/api/aluguel/desc/search/";
                }
                if(!checked) {
                    urlvar = "/api/aluguel/search/";
                }
            });
        };
        carrega();
