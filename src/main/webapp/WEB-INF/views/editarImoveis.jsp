...
<div class="container">
    <div class="section">
        <div class="row center">
            <h5 class="header col s12 light green-text">Editar Imovel</h5>
        </div>

        <div class="row">
            <form:form action="${pageContext.request.contextPath}/admin/editarImoveis?${_csrf.parameterName}=${_csrf.token}" method="post" commandName="imoveis" enctype="multipart/form-data">

                <form:hidden path="imovelId" value="${imoveis.imovelId}" />
